    ...
    return (
      <Container maxWidth="lg" className="minHeight">
        ...
        <ul>
          ...
          <li>
            <Typography variant="body1">
              The image does not contain defamatory, pornographic, harassing,
        ...
        <ul>
          ...
          <li>
            <Typography variant="body1">
              Post any user content that is defamatory, pornographic,
        ...
        <Typography variant="body1" paragraph>
          If you breach any of these Terms, your account and post will be
          delete.
        </Typography>
